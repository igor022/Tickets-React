...
function App() {
  ...
  const searchTickets = useMemo(() => tickets.filter((t) => 
  ...
  return (
    <div className="p-4 bg-gray-800 text-gray-400 text-sm min-h-screen">
      <div>
      ...
      <div className="grid grid-cols-4 gap-5 mt-3">
        <div className="col-span-1">
          <div className="relative border border-gray-600 mb-2 w-full">
            <input onChange={handleSearch} className="pl-6 h-7 rounded-sm bg-gray-800 w-full" type="text" />
          ...
          <UsersTable tickets={searchTickets} selectTicket={selectTicket} selected={selectedTicket?.ticketId}/>      
        </div>
